...
# list.insert(index, 값)
# -index에 값을 삽입하는 메서드
# - 지정된 index 부터 뒤에있는 모든 list
# 모드 list 값의 index가 증가(밀려남)
print("--- list,insert()---")
lst.insert(1, 1.5)
lst.insert(0, 0)
print("insert후 lst:", lst)
print("insert후 lst id :", id(lst))
print("insert후 lst id :", before_id==id(lst))
